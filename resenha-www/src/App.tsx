...
import { MapPin, Beer, Users, ChevronRight, ArrowRight, Menu, X, CheckCircle2, TrendingUp, Calendar, Trophy, Heart, Filter, ShoppingBag } from 'lucide-react';
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-gray-950/95 backdrop-blur-xl border-b border-white/10 animate-fade-in fixed inset-x-0 z-40 border-t border-white/5 shadow-2xl">
              <div className="px-4 pt-4 pb-8 space-y-4">
                ...
                <a href="#business" onClick={() => setIsMenuOpen(false)} className="block text-gray-300 hover:text-white py-3 px-4 rounded-lg hover:bg-white/5 transition-all text-lg font-medium">Para Bares</a>
                  ...
                  <div className="flex -space-x-4 hover:space-x-1 transition-all duration-300">
                    {[
                      ...
                      <div key={i} className="w-12 h-12 rounded-full border-2 border-gray-900 bg-gray-800 flex items-center justify-center shadow-lg transform transition-transform hover:scale-110 hover:z-20 relative z-10 overflow-hidden p-2">
                        <img src={url} alt={`Time ${i}`} className="w-full h-full object-contain" />
                      </div>
                    ))}
                  </div>
                </div>
                    ...
                    <div className="flex items-center gap-2 p-3 bg-gray-800/50 border border-white/5 rounded-xl backdrop-blur-sm">
                      <div className="flex -space-x-2">
                        {[
                          ...
                          <img key={i} src={src} className="w-8 h-8 rounded-full border-2 border-gray-800 object-cover" alt="User" />
                        ))}
                      </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="wow animate__animated animate__fadeInUp rounded-3xl bg-gradient-to-r from-gray-900 to-gray-800 border border-white/10 p-6 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="flex-1 space-y-6">
                ...
                <div className="pt-4">
                  <button className="px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-white font-bold rounded-xl transition-all shadow-lg shadow-emerald-500/25">
                    Cadastrar meu Bar
                  </button>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-400 mb-6 block">
                ResenhaConfirmada
              </span>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-500">
                ...
                <li><a href="#business" className="hover:text-emerald-400 transition-colors">Para Bares</a></li>
              </ul>
            </div>
